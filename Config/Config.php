...
const BASE_URL = 'http://localhost/proyectos/Vultan-main';
...
const NOMBRE_REMITENTE = 'RASTREO SATELITAL';
const EMAIL_REMITENTE = 'tiendadeartesaniasonline@gmail.com';
const NOMBRE_EMPESA = 'VULTAN';
const WEB_EMPRESA = 'www.abelosh.com';

const DESCRIPCION = 'VENTA DE EQUIPOS GPS.';
const SHAREDHASH = 'VULTAN';

// Datos Empresa
const DIRECCION = 'SAN JUAN DEL RIO, QUERETARO';
const TELEMPRESA = '+(52)78787845';
const WHATSAPP = '+5278787845';
...
const STATUS = ['Completo', 'Aprobado', 'Cancelado', 'Reembolsado', 'Pendiente', 'Entregado'];
