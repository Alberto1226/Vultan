 ...
 ?>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="<?= base_url().'/Assets/vultan/inicio/slider1.png'?>" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?= base_url().'/Assets/vultan/inicio/slider2.png'?>" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?= base_url().'/Assets/vultan/inicio/slider3.png'?>" alt="Third slide">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
	...
	<div class="col-xs-6 col-md-6" style=""><img src="<?= base_url().'/Assets/vultan/inicio/Img1.png'?>" alt="" style="width:100%;"></div>
	...
	<div class="col-xs-6 col-md-6" style=""><img src="<?= base_url().'/Assets/vultan/inicio/Img2.png'?>" alt="" style="width:100%;"></div>
	</div>

	<div class="row" style="padding:5vw;">
	<div class="col-xs-6 col-md-6" style=""><img src="<?= base_url().'/Assets/vultan/inicio/Img3.png'?>" alt="" style="width:100%;"></div>
	...
	<div class="grid-container">
        <div class="grid-item"><img src="<?= base_url().'/Assets/vultan/inicio/icono_Personal.png'?>" alt="Imagen 1"><p>Soluciones para uso personal</p></div>
        <div class="grid-item"><img src="<?= base_url().'/Assets/vultan/inicio/icono_Corporativas.png'?>" alt="Imagen 2"><p>Soluciones corporativas</p></div>
        <div class="grid-item"><img src="<?= base_url().'/Assets/vultan/inicio/icono_CentrodeMonitoreo.png'?>" alt="Imagen 3"><p>Soluciones para quienes buscan una central de monitoreo</p></div>
        <div class="grid-item"><img src="<?= base_url().'/Assets/vultan/inicio/icono_WebService.png'?>" alt="Imagen 4"><p>Soluciones Web Service/ API</p></div>
        <div class="grid-item"><img src="<?= base_url().'/Assets/vultan/inicio/icono_Resellers.png'?>" alt="Imagen 5"><p>Soluciones para resellers con marca blanca</p></div>
    </div>
	<!--Fin Vultan-->
